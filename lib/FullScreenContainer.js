...
export default class FullScreenContainer extends React.Component {
  ...
  static propTypes = {
    ...
    displayDownloadButton: PropTypes.bool,
    ...
    onDownloadButton: PropTypes.func,
  ...
  constructor(props, context) {
    ...
    this._onDownloadButtonTapped = this._onDownloadButtonTapped.bind(this);
  ...
  _onDownloadButtonTapped() {
    const onDownloadButton = this.props.onDownloadButton;

    // action behaviour must be implemented by the client
    // so, call the client method or simply ignore this event
    if (onDownloadButton) {
      const { currentMedia, currentIndex } = this.state;
      onDownloadButton(currentMedia, currentIndex);
    }
  }
    ...
    return (
      <View style={styles.flex}>
        ...
        <BottomBarComponent
          ...
          onDownloadAction={this._onDownloadButtonTapped}
        />
      </View>
    );
  }
